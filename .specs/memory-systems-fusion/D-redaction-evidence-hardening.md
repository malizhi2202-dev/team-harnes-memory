...
- `§3.5/§5.15[s5-16]/§5.16[s5-17]`：重算撤销、依赖计数、逐条证据形状三条语义。（GD-2/3 双票复审点：本行初稿仍写 §5.12/§5.13 与 ③.2 勘误自相矛盾——已按 ③.2 改齐；⑤ 题面引用清单原文时以本行为准。）
...
GD-2/3 双票复审同点一处文字残留：清单 `:41` 仍写 §5.12/§5.13，与 ③.2 勘误自相矛盾——**已按 ③.2 改齐为 §5.15[s5-16]/§5.16[s5-17]**，票面不变（两票原话）。
